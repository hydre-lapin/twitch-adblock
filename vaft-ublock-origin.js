/// twitch-videoad.js
// ==UserScript==
// @name         Twitch Ad Solutions (VAFT) - Clean & Secure
// @namespace    https://github.com/pixeltris/TwitchAdSolutions
// @version      2.5.0
// @description  Clean, secure, and stutter-free Twitch ad-blocking stream handler
...
(function () {
    ...
    const ourTwitchAdSolutionsVersion = 25;
    ...
    function getAccessToken(channelName, playerType) {
        const body = {
            ...
            extensions: {
                persistedQuery: {
                    version: 1,
                    sha256Hash: '0828119ded1c13477966434e15800ff57ddace7ba0e7726cbf5094f8116c41b'
                }
            }
        };
