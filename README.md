...
2. Cochez **« Je suis un utilisateur expérimenté »** et cliquez sur la roue dentée.
3. Définissez `userResourcesLocation` avec l'URL brute du script :
   ```text
   https://raw.githubusercontent.com/Lucas-Aster/twitch-adblock/main/vaft-ublock-origin.js
   ```
